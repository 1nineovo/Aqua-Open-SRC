...
namespace DrawUtil {
    ...
    // 在 DrawUtil.h 的 DrawUtil 类里面添加：
    void drawLine(const Vec3<float>& start, const Vec3<float>& end, const UIColor& color);
    void drawRing3d(const Vec3<float>& pos, float radius, const UIColor& color,
